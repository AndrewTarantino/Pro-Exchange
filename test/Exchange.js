...
describe('Exchange', () => {
  ...
  beforeEach(async () => {
    ...
    token1 = await Token.deploy('Protein', 'PRO', '1000000')
  ...
  describe ('Making orders', async () => {
    ...
    describe('Success', async () => {
      ...
      it('tracks the newly created oreder', async () => {
    ...
    describe('Failure', async () => {
      it('Rejects with no balances', async () => {
    ...
    describe('Filling orders', async () => {
      ...
      describe('Success', () => {
        ...
        it('Executes the trade and charge fees', async () => {
          ...
          expect(await exchange.balanceOf(token2.address, user2.address)).to.equal(tokens(0.98))
          expect(await exchange.balanceOf(token2.address, feeAccount.address)).to.equal(tokens(0.02))
        })
